...
public class FirstVisitMonteCarloControlRLLearner {
     ...
     * Current episode
     */
    List<AbstractMap.SimpleEntry<String, Object>> episode; // A list of state-action pairs. The key of the SimpleEntry is the state in the string encoding, while the value of the SimpleEntry is the action taken in the state.
    /**
    ...
    FirstVisitMonteCarloControlRLLearner(int id, List<Object> actionSpace, double epsilon, double minEpsilon, double decay, Random rand) {
        this.id = id;
