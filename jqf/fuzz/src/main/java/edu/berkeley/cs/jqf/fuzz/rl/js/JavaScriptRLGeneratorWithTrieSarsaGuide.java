...
public class JavaScriptRLGeneratorWithTrieSarsaGuide implements RLGenerator {

    private TrieBasedSarsaLearner learner;
    ...
    public JavaScriptRLGeneratorWithTrieSarsaGuide() {
    }
